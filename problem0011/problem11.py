...
highestProduct = 0
'''
top to bottom math (lines and left to right diagonols)
'''
# highest product in row
for row in range(19):
    for column in range(16):
        total = grid(row](column] * grid(row](column + 1]\
            * grid(row](column + 2] * grid(row](column + 3]
        if total > highestProduct:
            highestProduct = total

# highest product in column
for column in range(19):
    for row in range(16):
        total = grid(row](column] * grid(row + 1](column]\
            * grid(row + 2](column] * grid(row + 3](column]
        if total > highestProduct:
            highestProduct = total

# highest product in left down to right diagonol
for row in range(16):
    for column in range(16):
        total = grid(row](column] * grid(row + 1](column + 1]\
            * grid(row + 2](column + 2] * grid(row + 3](column + 3]
        if total > highestProduct:
            highestProduct = total
'''
bottom to top math (right to left diagonols)
'''
# highest product in right up to left diagonol
for row in range(19, 3, -1):
    for column in range(19, 3, -1):
        total = grid(row](column] * grid(row - 1](column - 1]\
            * grid(row - 2](column - 2] * grid(row - 3](column - 3]
        if total > highestProduct:
            highestProduct = total

# highest product in a left up to right diagonol
for row in range(19, 3, -1):
    for column in range(16):
        total = grid(row](column] * grid(row - 1](column + 1]\
            * grid(row - 2](column + 2] * grid(row - 3](column + 3]
